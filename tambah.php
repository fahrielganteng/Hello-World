...
if (isset($_POST['submit'])) {
    ...
    $nama = trim($_POST['nama_barang']); // Nama barang dari input form
    $harga = trim($_POST['harga_barang']); // Harga barang dari input form
    $stok = trim($_POST['stok_barang']); // Stok barang dari input form
